<section id="highlight">
	<div class="container">
		...
		<div class="sessionDeleted flex">
			...
			<p style="margin-right: 2rem;">Since there is no persisdent data, sessions are deleted after both the parties exist the room</p>
		</div>
		<div class="noInterruptions flex">
			<p style="margin-left: 2rem;">Messages are encrypted using asymmetric keys; tamper and intercept proof and session is locked once two people join a room</p>
