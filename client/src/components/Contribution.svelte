...
<div class="contribution">
	<div class="flex" style="cursor: pointer;" on:click={()=>{expand = !expand}}>
		<span class="content">If you find this product useful, please consider supporting</span>
	...
	{#if expand}
		<div transition:slide style="margin-top: 1rem;">
			...
			<p>
				If you have any queries, please reach out to hi@keychat.online
			</p>
			<a href="https://www.buymeacoffee.com/KEJSRzZ" target="_blank">
				<div class="coffewrapper">
					<img src="https://cdn.buymeacoffee.com/buttons/v2/default-yellow.png" alt="Buy Me A Coffee" style="height: 2.8rem !important;" >
				</div>
			</a>
		</div>
	{/if}
